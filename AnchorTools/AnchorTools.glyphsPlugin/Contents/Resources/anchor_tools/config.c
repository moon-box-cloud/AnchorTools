...
{
    "distutils": {
        "name": "anchor_tools.config",
        "sources": [
            "AnchorTools/AnchorTools.glyphsPlugin/Contents/Resources/anchor_tools/config.py"
        ]
    },
    "module_name": "anchor_tools.config"
}
END: Cython Metadata */
...
#define __PYX_HAVE__anchor_tools__config
#define __PYX_HAVE_API__anchor_tools__config
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "anchor_tools.config" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "anchor_tools.config"
extern int __pyx_module_is_main_anchor_tools__config;
int __pyx_module_is_main_anchor_tools__config = 0;

/* Implementation of "anchor_tools.config" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_thai_viet_deva_arab_khmr[] = "\n\351\205\215\347\275\256\344\270\216\351\242\204\350\256\276\357\274\232\350\204\232\346\234\254\345\257\271\345\272\224\347\232\204\351\224\232\347\202\271\351\233\206\345\220\210\343\200\201\351\273\230\350\256\244\345\217\202\346\225\260\347\255\211\343\200\202\n\345\220\216\347\273\255\345\217\257\344\273\245\345\234\250\350\277\231\351\207\214\346\211\251\345\261\225\346\233\264\345\244\232\350\204\232\346\234\254\357\274\210thai, viet, deva, arab, khmr...\357\274\211\343\200\202\n";
/* #### Code section: decls ### */
...
#define __pyx_kp_u_one_AnchorTools __pyx_string_tab[2]
#define __pyx_kp_u_top_bottom __pyx_string_tab[3]
#define __pyx_n_u_DEFAULT_ADJUST_Y __pyx_string_tab[4]
#define __pyx_n_u_DEFAULT_ANCHOR_NAMES __pyx_string_tab[5]
#define __pyx_n_u_DEFAULT_LETTERS_ONLY __pyx_string_tab[6]
#define __pyx_n_u_DEFAULT_MARKS_ONLY __pyx_string_tab[7]
#define __pyx_n_u_DEFAULT_METHOD_INDEX __pyx_string_tab[8]
#define __pyx_n_u_DEFAULT_SCOPE_INDEX __pyx_string_tab[9]
#define __pyx_n_u_DEFAULT_SCRIPT_FILTER __pyx_string_tab[10]
#define __pyx_n_u_PREF_DOMAIN __pyx_string_tab[11]
#define __pyx_n_u_SCRIPT_ANCHOR_PRESETS __pyx_string_tab[12]
#define __pyx_n_u_base __pyx_string_tab[13]
#define __pyx_n_u_bottom __pyx_string_tab[14]
#define __pyx_n_u_bottom_2 __pyx_string_tab[15]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[16]
#define __pyx_n_u_latn __pyx_string_tab[17]
#define __pyx_n_u_main __pyx_string_tab[18]
#define __pyx_n_u_mark __pyx_string_tab[19]
...
#define __pyx_n_u_top_2 __pyx_string_tab[26]
...
namespace {
  ...
  #endif
  {
      ...
      "config",
      __pyx_k_thai_viet_deva_arab_khmr, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_RefNannySetupContext("PyInit_config", 0);
  ...
  if (__pyx_module_is_main_anchor_tools__config) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "anchor_tools.config")) {
      if (unlikely((PyDict_SetItemString(modules, "anchor_tools.config", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "anchor_tools/config.py":8
 * 
 * #  Info.plist  bundle id
 * PREF_DOMAIN = "one.AnchorTools"             # <<<<<<<<<<<<<<
 * 
 * #  Anchors UI
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_PREF_DOMAIN, __pyx_mstate_global->__pyx_kp_u_one_AnchorTools) < (0)) __PYX_ERR(0, 8, __pyx_L1_error)

  /* "anchor_tools/config.py":11
 * 
 * #  Anchors UI
 * DEFAULT_ANCHOR_NAMES = "top,bottom"             # <<<<<<<<<<<<<<
 * 
 * # mean / median / first
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_DEFAULT_ANCHOR_NAMES, __pyx_mstate_global->__pyx_kp_u_top_bottom) < (0)) __PYX_ERR(0, 11, __pyx_L1_error)

  /* "anchor_tools/config.py":14
 * 
 * # mean / median / first
 * DEFAULT_METHOD_INDEX = 0  # 0=mean,1=median,2=first             # <<<<<<<<<<<<<<
 * 
 * # Selection / Current glyph / Whole font
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_DEFAULT_METHOD_INDEX, __pyx_mstate_global->__pyx_int_0) < (0)) __PYX_ERR(0, 14, __pyx_L1_error)

  /* "anchor_tools/config.py":17
 * 
 * # Selection / Current glyph / Whole font
 * DEFAULT_SCOPE_INDEX = 0  # 0=Selection             # <<<<<<<<<<<<<<
 * 
 * #  harmonize Y
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_DEFAULT_SCOPE_INDEX, __pyx_mstate_global->__pyx_int_0) < (0)) __PYX_ERR(0, 17, __pyx_L1_error)

  /* "anchor_tools/config.py":20
 * 
 * #  harmonize Y
 * DEFAULT_ADJUST_Y = False             # <<<<<<<<<<<<<<
 * 
 * # category
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_DEFAULT_ADJUST_Y, Py_False) < (0)) __PYX_ERR(0, 20, __pyx_L1_error)

  /* "anchor_tools/config.py":23
 * 
 * # category
 * DEFAULT_LETTERS_ONLY = False             # <<<<<<<<<<<<<<
 * DEFAULT_MARKS_ONLY = False
 * 
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_DEFAULT_LETTERS_ONLY, Py_False) < (0)) __PYX_ERR(0, 23, __pyx_L1_error)

  /* "anchor_tools/config.py":24
 * # category
 * DEFAULT_LETTERS_ONLY = False
 * DEFAULT_MARKS_ONLY = False             # <<<<<<<<<<<<<<
 * 
 * #
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_DEFAULT_MARKS_ONLY, Py_False) < (0)) __PYX_ERR(0, 24, __pyx_L1_error)

  /* "anchor_tools/config.py":27
 * 
 * #
 * DEFAULT_SCRIPT_FILTER = ""             # <<<<<<<<<<<<<<
 * 
 * #
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_DEFAULT_SCRIPT_FILTER, __pyx_mstate_global->__pyx_kp_u_) < (0)) __PYX_ERR(0, 27, __pyx_L1_error)

  /* "anchor_tools/config.py":31
 * #
 * SCRIPT_ANCHOR_PRESETS = {
 *     "latn": {             # <<<<<<<<<<<<<<
 *         "base": ["top", "bottom"],
 *         "mark": ["_top", "_bottom"],
*/
...
*/
  ...
  __pyx_t_4 = __Pyx_PyList_Pack(2, __pyx_mstate_global->__pyx_n_u_top, __pyx_mstate_global->__pyx_n_u_bottom); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_base, __pyx_t_4) < (0)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

  /* "anchor_tools/config.py":33
 *     "latn": {
 *         "base": ["top", "bottom"],
 *         "mark": ["_top", "_bottom"],             # <<<<<<<<<<<<<<
 *     },
 *     #  thai, viet, deva
*/
  __pyx_t_4 = __Pyx_PyList_Pack(2, __pyx_mstate_global->__pyx_n_u_top_2, __pyx_mstate_global->__pyx_n_u_bottom_2); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_mark, __pyx_t_4) < (0)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_latn, __pyx_t_3) < (0)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_SCRIPT_ANCHOR_PRESETS, __pyx_t_2) < (0)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "anchor_tools/config.py":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * """
 * 
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init anchor_tools.config", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init anchor_tools.config");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{0},{1},{15},{10},{16},{20},{20},{18},{20},{19},{21},{11},{21},{4},{6},{7},{18},{4},{8},{4},{10},{8},{12},{10},{8},{3},{4}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (237 bytes) */
const char* const cstring = "BZh91AY&SY<Y\327\027\000\000\002_\200@\000\000\005\000\000\257\177\336`\277o\376\0000\000\314\230hS\324\322{T\332\215\2442a\000\323\324\302\031\3520M\006\203@\310\304\320\032\001(\203SLI\243@\032\000\000u\022\356i\032\320$\010\267(\260\262\301\014`\024p}\261\"\272\361\0046\272q}\204O9j3@\255\t+\366b\211y|,QH\217\027l\242M\344m\203\027\014J\342\301\246\257)n9/X\243\212\n\206_uD\336\305\030RI\202\341\027%f+\221\201p\220\372\232\213\322r\030\233\252\364\355\224$\331\311\374=\243d\363|4VP\222\333:\021\225\354\372\226\270\243\2411\212\001\314\021\265\031\2664-H\342\322\324-m)\311\215i\024\306\002\271\0042\000\304\005\017\256/\342\356H\247\n\022\007\213:\342\340";
    PyObject *data = __Pyx_DecompressString(cstring, 237, 2);
...
const char* const cstring = "x\332]\216Q\016\2020\014\206/d\274\202Y\\\t(ld\233\211>5\003g$\214\025a\334_\024\360\301&\375\333~m\332\036(\270=\013\365\223\006C\344\307H\375\256\242\030\251\343\220\260Kn\220\361\323E\033\274\375jqL\245B\301\n\320\033\313\301\030P\032\245\310\177s\005S\347?\002&\225\0343\301\341\2721}\224%\374#\225\225\006\223,\237w\226\n\022\344\262`\231X\371z\177nh0\272\262\243[\376\305%\324\276\t\016\233\200q\260\265\253l\335z\033\003bg\233\257\016\355\254t\237\274\303\331\202\355\276\3615Y\277\344\243\213w\367\260\223\217\210\321\215\037\245\376\343o\226\200g\273";
...
const char* const bytes = "?one.AnchorToolstop,bottomDEFAULT_ADJUST_YDEFAULT_ANCHOR_NAMESDEFAULT_LETTERS_ONLYDEFAULT_MARKS_ONLYDEFAULT_METHOD_INDEXDEFAULT_SCOPE_INDEXDEFAULT_SCRIPT_FILTERPREF_DOMAINSCRIPT_ANCHOR_PRESETSbasebottom_bottomcline_in_tracebacklatn__main__mark__module____name____qualname__setdefault__test__top_top";
    PyObject *data = NULL;
